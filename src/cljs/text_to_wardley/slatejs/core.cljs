(ns text-to-wardley.slatejs.core
  (:require
...
(def is-hotkey-mod-b (slate/isHotkey "mod+b"))
(def is-hotkey-mod-i (slate/isHotkey "mod+i"))
...
(def html-serializer (slate/Html. (clj->js {:rules html-serializer-rules})))
